(function () {
    ...
    optsClass.prototype.getOpts = function () {
        ...
        if (args.newswriter_port) {
            console.log("Reading config from gslfrontpage-" + args.newswriter_port + ".cfg");
            try {
                var newconfig = JSON.parse(fs.readFileSync('gslfrontpage-' + args.newswriter_port + '.cfg'));
        ...
        if (saveConfig) {
            ...
            fs.writeFileSync('gslfrontpage-' + this.config.newswriter_port + '.cfg', configJson);
            console.log("Wrote config parameters to gslfrontpage-" + this.config.newswriter_port + '.cfg');
            console.log("GSL Frontpage can now be run with the single option: -p " + this.config.newswriter_port);
        }
