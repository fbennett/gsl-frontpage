    ...
    optsClass.prototype.getOpts = function () {
        ...
        var UrlEngine = function (config) {
            ...
            if ('string' === typeof arg) {
                ...
                this.hostname_and_port = config.proxy_hostname + port;
            }
        };
        ...
        UrlEngine.prototype.page = function (id,key) {
            ...
            return 'http://' + this.hostname_and_port + '/' + this.stub + '?' + this.adminstuff + this.getQueryString({id:id,key:key});
        };
        ...
        UrlEngine.prototype.hostpath = function () {
            ...
            if (this.testInstance) {
                ...
                ret = this.hostname_and_port + '/' + this.config.gslfrontpage_path;
            }
            return ret;
        };
