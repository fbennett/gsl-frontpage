(function () {
    ...
    sysClass.prototype.getSys = function () {
        ...
        function getEventData(response,eventID,callback) {
            var data = {
                eventID:eventID,
                attachments:[],
                sessions:[]
            ...
            function getEvent() {
                ...
                var sql = 'SELECT convenorID,'
                    ...
                    + 'presenternames.name AS presenterName,presentercontacts.contact AS presenterContact,presenteraffiliations.affiliation AS presenterAffiliation,presenterpositions.position AS presenterPosition,status,published '
                    + 'FROM events '
