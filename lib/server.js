        ...
        http.createServer(function (request, response) {
            ...
            if (sys.admin[params.admin]
                ...
                form.parse(request, function(err, fields, files) {
                    ...
                    console.log("fields.pageDate="+fields.pageDate);
                    var pageDate = null;
                    ...
                    console.log("dateFlag="+dateFlag+", searchableTitle="+fields.searchableTitle);
                    ...
                    function addDocument (titleID) {
                        ...
                        sys.db.run(sql,[titleID,mimeType,filenameExtension,pageDate],function(err){
                    ...
                    if (uriObj.href.match(/\/attachments\/[0-9]+$/)) {
                        ...
                        sys.db.get(sql,[documentID],function(err,row){
                            ...
                            if (row && row.title) {
                                ...
                                console.log("MIME TYPE: "+row.mimeType+" "+row.title);
