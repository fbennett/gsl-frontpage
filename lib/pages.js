                ...
                events:{
                    ...
                    '@@LEDE@@':function(data) {
                        ...
                        if (data.note) {
                            ...
                            ret = 'We are pleased to announce a @@HOST@@presentation by @@PRESENTER_POSITION@@ @@PRESENTER_NAME@@ of @@PRESENTER_AFFILIATION@@:';
                ...
                event:{
                    ...
                    '@@LEDE@@':function(data) {
                        ...
                        if (data.note) {
                            ...
                            ret = this.sys.markdown('We are pleased to announce a @@HOST@@presentation by @@PRESENTER_POSITION@@ @@PRESENTER_NAME@@ of @@PRESENTER_AFFILIATION@@:\n\n> @@TITLE@@');
                        }
                        return ret;
                    },
                    '@@DESCRIPTION@@':function(data) {
                ...
                events:{
                    ...
                    '@@LEDE@@':function(data) {
                        ...
                        if (data.note) {
                            ...
                            ret = this.sys.markdown('We are pleased to announce a @@CONVENOR_AFFILIATION@@presentation by @@PRESENTER_POSITION@@ @@PRESENTER_NAME@@ of @@PRESENTER_AFFILIATION@@:\n\n> @@TITLE@@.');
                        }
                        return ret;
                    },
                    '@@DESCRIPTION@@':function(data) {
