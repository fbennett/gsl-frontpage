...
var attachmentHtmlTemplate = '<tr>'
    ...
    +'   <td class="document">'
    + '    <div>'
    + '      <input id="document@@DOCUMENT_ID@@-attachment" class="document-title field field-closed form-input" type="text" size="50" value="@@DOCUMENT_TITLE@@" onblur="soloFieldBlur(event);" onfocus="soloFieldFocus(event);" onkeydown="attachmentTitleKeydown(event);" onkeyup="attachmentTitleKeyup(event);"/>'
    + '    </div>'
    + '  </td>'
    + '  <td rowspan="2">'
...
var sessionHtmlTemplate = '<tr>'
    ...
    + '    <input id="session@@SESSION_ID@@-title" value="@@TITLE@@" class="has-content form-input" disabled="true" type="text" size="50"/>'
    + '  </td>'
    + '  <td rowspan="2">'
    ...
    + '    <input id="session@@SESSION_ID@@-place" value="@@PLACE@@" class="has-content form-input" disabled="true" type="text" size="10"/>'
    + '  </td>'
    + '  <td>'
    + '    <span class="day-of-week">@@DOW@@</span>'
    + '    <input id="session@@SESSION_ID@@-date" value="@@DATE@@" class="has-content form-input" size="10" disabled="true" type="text"/>'
    + '    <input id="session@@SESSION_ID@@-hour-start" value="@@START@@" class="has-content form-input" disabled="true" size="5"/>'
    + '〜'
    + '<input id="session@@SESSION_ID@@-hour-end" value="@@END@@" class="has-content form-input" disabled="true" size="5"/>'
    + '  </td>'
    + '</tr>'
